...
static reloc_howto_type or1k_elf_howto_table[R_OR1K_max] =
{
			...
			const char *r_name)
{
  ...
  for (i = 0; i < (unsigned int) R_OR1K_max; i++)
  ...
  for (rel = relocs; rel < relend; rel++)
	...
	case R_OR1K_GOT_LO13:
	  ...
	  _bfd_error_handler
	    ...
	    /* The PG21 and LO13 relocs are pc-relative,
	       while the reset are GOT relative.  */
