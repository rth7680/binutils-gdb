...
typedef enum insn_opcode_alu_regreg {
 ...
 , OPC_ALU_REGREG_CMOV = 14, OPC_ALU_REGREG_FF1 = 15, OPC_ALU_REGREG_SLL = 8, OPC_ALU_REGREG_SRL = 72
 , OPC_ALU_REGREG_SRA = 136, OPC_ALU_REGREG_ROR = 200, OPC_ALU_REGREG_FL1 = 271, OPC_ALU_REGREG_MUL = 774
 , OPC_ALU_REGREG_MULD = 775, OPC_ALU_REGREG_DIV = 777, OPC_ALU_REGREG_DIVU = 778, OPC_ALU_REGREG_MULU = 779
 , OPC_ALU_REGREG_MULDU = 781
