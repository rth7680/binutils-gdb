...
const CGEN_IFLD or1k_cgen_ifld_table[] =
{
  ...
  { OR1K_F_OP_10_11, "f-op-10-11", 0, 32, 10, 11, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR32ND)|(1<<MACH_OR64)|(1<<MACH_OR64ND), 0 } } } }  },
  { OR1K_F_OP_10_5, "f-op-10-5", 0, 32, 10, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR32ND)|(1<<MACH_OR64)|(1<<MACH_OR64ND), 0 } } } }  },
  ...
  { OR1K_F_RESV_15_5, "f-resv-15-5", 0, 32, 15, 5, { 0|A(RESERVED), { { { (1<<MACH_OR32)|(1<<MACH_OR32ND)|(1<<MACH_OR64)|(1<<MACH_OR64ND), 0 } } } }  },
...
/* l.lda $rD,${simm16}($rA) */
  {
    OR1K_INSN_L_LDA, "l-lda", "l.lda", 32,
    { 0, { { { (1<<MACH_OR64)|(1<<MACH_OR64ND), 0 } } } }
  },
/* l.lwa $rD,${simm16}($rA) */
  {
...
/* l.sda ${simm16-split}($rA),$rB */
  {
    OR1K_INSN_L_SDA, "l-sda", "l.sda", 32,
    { 0, { { { (1<<MACH_OR64)|(1<<MACH_OR64ND), 0 } } } }
  },
