...
typedef enum insn_opcode_alu_regreg {
  OPC_ALU_REGREG_EXTHS = 12, OPC_ALU_REGREG_EXTWS = 13, OPC_ALU_REGREG_EXTBS = 76, OPC_ALU_REGREG_EXTWZ = 77
 , OPC_ALU_REGREG_EXTHZ = 140, OPC_ALU_REGREG_EXTBZ = 204, OPC_ALU_REGREG_ADD = 0, OPC_ALU_REGREG_ADDC = 1
 , OPC_ALU_REGREG_SUB = 2, OPC_ALU_REGREG_AND = 3, OPC_ALU_REGREG_OR = 4, OPC_ALU_REGREG_XOR = 5
 , OPC_ALU_REGREG_SUBB = 6, OPC_ALU_REGREG_CMOV = 14, OPC_ALU_REGREG_FF1 = 15, OPC_ALU_REGREG_SLL = 8
 , OPC_ALU_REGREG_SRL = 72, OPC_ALU_REGREG_SRA = 136, OPC_ALU_REGREG_ROR = 200, OPC_ALU_REGREG_FL1 = 271
 , OPC_ALU_REGREG_MUL = 774, OPC_ALU_REGREG_MULD = 775, OPC_ALU_REGREG_DIV = 777, OPC_ALU_REGREG_DIVU = 778
 , OPC_ALU_REGREG_MULU = 779, OPC_ALU_REGREG_MULDU = 781
...
typedef enum ifield_type {
 ...
 , OR1K_F_OP_16_1, OR1K_F_OP_10_11, OR1K_F_OP_10_5, OR1K_F_OP_7_8
 , OR1K_F_OP_3_4, OR1K_F_RESV_25_26, OR1K_F_RESV_25_10, OR1K_F_RESV_25_5
 , OR1K_F_RESV_23_8, OR1K_F_RESV_20_21, OR1K_F_RESV_20_5, OR1K_F_RESV_20_4
 , OR1K_F_RESV_15_5, OR1K_F_RESV_10_11, OR1K_F_RESV_10_7, OR1K_F_RESV_10_3
